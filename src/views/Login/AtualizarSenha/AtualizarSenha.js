...
const urlLogin = 'https://vendas-analytics-app-hom.herokuapp.com/#/login';
const urlAlterarSenha = 'https://vendas-analytics-api-postgres.herokuapp.com/api/usuarios/atualizar-senha';
let token = '';
