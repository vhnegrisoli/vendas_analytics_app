      ...
      <div className="animated fadeIn">
                  ...
                  >
                    ...
                    <DropdownMenu right>
                      ...
                      {this.state.clientes.map(cliente => (
                        <DropdownItem>{cliente.nome}</DropdownItem>
                      ))}
                      {this.state.clientes.map(cliente => (
                        <DropdownItem>{cliente.endereco.cidade.estado.regiao.nome}</DropdownItem>
                      ))}
                    </DropdownMenu>
                  </Dropdown>
                </ButtonGroup>
        ...
        <Row>
          ...
          <Col xs="6" sm="6" lg="3">
            <Suspense fallback={this.loading()}>
              <Widget03
                dataBox={() => ({ variant: 'twitter', followers: '973k', tweets: '1.792' })}
              >
                <div className="chart-wrapper">
          ...
          <Col xs="6" sm="6" lg="3">
            <Suspense fallback={this.loading()}>
              <Widget03
                dataBox={() => ({ variant: 'google-plus', followers: '894', circles: '92' })}
              >
                <div className="chart-wrapper">
